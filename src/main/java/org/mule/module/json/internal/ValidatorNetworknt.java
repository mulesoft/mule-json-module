...
public class ValidatorNetworknt extends Validator {
  ...
  public Validator create(JsonNode jsonNode, String schemaLocation, JsonSchemaDereferencingMode dereferencing,
    ...
    jsonSchema = loadSchemaNetworkntLibrary(jsonNode, schemaLocation, schemaRedirects);
    return this;
  }
   ...
   */
  private com.networknt.schema.JsonSchema loadSchemaNetworkntLibrary(JsonNode jsonNode, String schemaLocation,
    ...
    try {
      ...
      if (schemaLocation == null) {
        return schemaFactory.getSchema(jsonNode, getUriRedirectConfigNetworknt(schemaRedirects));
      } else {
        return schemaFactory.getSchema(new URI(resolveLocationIfNecessary(schemaLocation)),
                                       getUriRedirectConfigNetworknt(schemaRedirects));
      }
  ...
  private SchemaValidatorsConfig getUriRedirectConfigNetworknt(Map<String, String> schemaRedirects) {
