...
public class SchemaValidatorNetworknt extends JsonSchemaValidator{
    ...
    public SchemaValidatorNetworknt(String schemaLocation, JsonSchemaDereferencingMode dereferencing, boolean allowDuplicateKeys, boolean allowArbitraryPrecision, Map<String, String> redirects, JsonNode jsonSchemaNode) {
