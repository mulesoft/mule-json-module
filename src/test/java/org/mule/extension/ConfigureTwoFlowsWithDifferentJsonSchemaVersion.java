...
public class ConfigureTwoFlowsWithDifferentJsonSchemaVersion extends AbstractSchemaValidationTestCase {
    ...
    public void RunFlowsAndMakeValidations() throws Exception {
        ...
        runTestWithSchemaAndExpectError(SCHEMA_FIELD_INTEGER_REQUIRED_DRAFT7, inputFieldString, FLOW1, ERROR_MSG_EXPECTED_STRING_FOUND_INT_EXP);
